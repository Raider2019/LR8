...
<head>
    ...
    <title>Таблиця contacts actors</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <h1>Таблиця contacts actors</h1>
    ...
    if($result = $mysqli->query('SELECT * FROM `contacts_actors` ')) {   // $mysqli - наш об'єкт, через який здійснюємо підключення, query - метод, який дозволяє виконати довільний запит
