...
<head>
    ...
    <title>Таблиця Contact Rez</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <h1>Таблиця Contact Rez</h1>
    ...
    if($result = $mysqli->query('SELECT * FROM `contacts_rez` ')) {   // $mysqli - наш об'єкт, через який здійснюємо підключення, query - метод, який дозволяє виконати довільний запит
